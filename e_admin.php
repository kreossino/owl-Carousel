...
class owl_carousel_admin
{
	...
	public function config($ui)
	{
		...
		//Note: 'urls' will be returned as $_POST['x_owl_carousel_url']. ie. x_{PLUGIN_FOLDER}_{YOURFIELDKEY}
	...
	public function process($ui, $id=0)
	{
		...
		if(!empty($id) )
		{
			...
			if(!empty($data['x_owl_carousel_url']))
			{

				// Save the data in 'owl_carousel' plugin table. .
